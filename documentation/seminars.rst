...
#. | A. Jiménez-Cordero, J. M. Morales, and S. Pineda, `Feature selection in nonlinear SVM using a novel min-max approach`, NeEDS Machine Learning NeEDS Mathematical Optimization online seminars February 2021. Watch the seminar `here <https://youtu.be/IlZPrleWjmY?t=43>`_.
